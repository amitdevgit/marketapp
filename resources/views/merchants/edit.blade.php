...
<div class="mb-8">
    <div class="flex items-center">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Edit Merchant</h1>
            <p class="mt-2 text-sm text-gray-600">Update merchant information.</p>
        </div>
    </div>
</div>
@endsection
...
<div class="bg-white rounded-xl shadow-lg p-8">
    <form action="{{ route('merchants.update', $merchant) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input 
                    ...
                    id="gst_number" 
                    name="gst_number" 
                    value="{{ old('gst_number', $merchant->gst_number) }}"
            ...
            <div class="flex items-center">
                <input 
                    ...
                    name="is_active" 
                    value="1"
                    {{ (old('is_active', $merchant->is_active) == 1 || old('is_active', $merchant->is_active) === true) ? 'checked' : '' }}
        ...
        <div>
            ...
            >{{ old('notes', $merchant->notes) }}</textarea>
            @error('notes')
                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
